...
Para operar staging o producción, consulta [`docs/production.md`](docs/production.md). Los despliegues de producción requieren validación, recursos aislados y confirmación explícita.
